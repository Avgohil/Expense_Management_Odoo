...
import { mockSignup } from '../../store/authSlice'
...
export default function Signup(){
  ...
  function handleSubmit(e){
    e.preventDefault()
    const res = mockSignup({company,name,email,password,role})
    if(res.success){
  ...
  <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-6 animate-pop">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <button type="submit" className="px-4 py-2 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded">Signup</button>
          </div>
        </form>
